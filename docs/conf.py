...
htmlhelp_basename = 'RequirementsLibdoc'
...
latex_documents = [
    (master_doc, 'RequirementsLib.tex', 'RequirementsLib Documentation',
...
man_pages = [
    (master_doc, 'requirementslib', 'RequirementsLib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'RequirementsLib', 'RequirementsLib Documentation',
     author, 'RequirementsLib', 'One line description of project.',
     'Miscellaneous'),
]
